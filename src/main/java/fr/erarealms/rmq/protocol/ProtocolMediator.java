...
import fr.erarealms.rmq.connect.DefaultConnector;
import fr.erarealms.rmq.protocol.store.ProtocolBucket;
import fr.erarealms.rmq.query.Request;
import fr.erarealms.rmq.allocate.DefaultThreadPoolAllocator;
import fr.erarealms.rmq.allocate.ThreadPoolAllocator;
import fr.erarealms.rmq.connect.Connector;
import fr.erarealms.rmq.connect.Credentials;
import fr.erarealms.rmq.forward.Forwarder;
